...
public class ProveedorMiembrosPlanilla2 implements ProveedorMiembrosPlanilla {

    private static final Random random = new Random();
    Logger logger = LoggerFactory.getLogger(ProveedorMiembrosPlanilla2.class);


    @Override
    public List<Empleado> getEmpleadosByPlantilla(String id) {
        var empleados = generateRandomEmpleados();
        logger.info("lista de empleados proveedor 2: " + empleados);
        return empleados;
    }
    ...
    private static Empleado generateRandomEmpleado() {
        ...
        String nombre = "Employee From Provider 2: " + id;
